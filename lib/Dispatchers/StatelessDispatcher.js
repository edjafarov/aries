...
/* NEED to set up configurations to pass requests to methods of class - not controller
...
StatelessDispatcher.prototype.init = function init(){
            ...
            this.cache.put(this.viewResolver, this.dispatcherContext[ClassLoader.getClassName(this.viewResolver)]);
             ...
             for(var i=0;i<this.filters.length-1;i++){
                ...
                this.dispatcherContext[ClassLoader.getClassName(this.filters[this.filters.length-1])].prototype.doNext 
             ...
             for(var i=0;i<this.interceptors.length-1;i++){
                ...
                this.dispatcherContext[ClassLoader.getClassName(this.interceptors[this.interceptors.length-1])].prototype.doNext 
